...
class RunDto(Model):
    ...
    def __init__(self, run_number=None, root_run_id=None, experiment_id=None, created_utc=None, user_id=None, token=None, token_expiry_time_utc=None, run_id=None, parent_run_id=None, status=None, start_time_utc=None, end_time_utc=None, heartbeat_enabled=None, options=None, name=None, data_container_id=None, description=None, hidden=None, run_type=None, parent_run_uuid=None, root_run_uuid=None, run_uuid=None, properties=None, script_name=None, target=None, tags=None, run_definition=None, primary_metric_name=None, created_from=None, created_by=None, cancel_uri=None, complete_uri=None, diagnostics_uri=None, error=None, warnings=None, queueing_info=None):
